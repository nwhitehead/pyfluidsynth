...
def schedule_next_sequence():
    ...
    # melody
    sequencer.note(
        int(now + seqduration * 1 / 10),
        1,
        45,
        duration=250,
        velocity=int(127 * 2 / 3),
        dest=synthSeqID,
    )
    sequencer.note(
        int(now + seqduration * 4 / 10),
        1,
        50,
        duration=250,
        velocity=int(127 * 2 / 3),
    ...
    sequencer.note(
        int(now + seqduration * 8 / 10),
        1,
        55,
        duration=250,
        velocity=int(127 * 3 / 3),
        dest=synthSeqID,
    )
