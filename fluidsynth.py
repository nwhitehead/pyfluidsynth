...
delete_fluid_mod = cfunc('delete_fluid_mod', c_void_p,
                        ('mod', c_void_p, 1))

fluid_mod_clone = cfunc('fluid_mod_clone', c_void_p,
                       ('mod', c_void_p, 1),
                       ('src', c_void_p, 1))

fluid_mod_get_amount = cfunc('fluid_mod_get_amount', c_void_p,
                            ('mod', c_void_p, 1))

fluid_mod_get_dest = cfunc('fluid_mod_get_dest', c_void_p,
                          ('mod', c_void_p, 1))

fluid_mod_get_flags1 = cfunc('fluid_mod_get_flags1', c_void_p,
                            ('mod', c_void_p, 1))

fluid_mod_get_flags2 = cfunc('fluid_mod_get_flags2', c_void_p,
                            ('mod', c_void_p, 1))

fluid_mod_get_source1 = cfunc('fluid_mod_get_source1', c_void_p,
                             ('mod', c_void_p, 1))

fluid_mod_get_source2 = cfunc('fluid_mod_get_source2', c_void_p,
                             ('mod', c_void_p, 1))

fluid_mod_get_transform = cfunc('fluid_mod_get_transform', c_void_p,
                               ('mod', c_void_p, 1))

fluid_mod_has_dest = cfunc('fluid_mod_has_dest', c_void_p,
                          ('mod', c_void_p, 1),
                          ('gen', c_uint, 1))

fluid_mod_has_source = cfunc('fluid_mod_has_dest', c_void_p,
                            ('mod', c_void_p, 1),
                            ('cc', c_uint, 1),
                            ('ctrl', c_uint, 1))

fluid_mod_set_amount = cfunc('fluid_mod_set_amount', c_void_p,
                            ('mod', c_void_p, 1),
                            ('amount', c_double, 1))

fluid_mod_set_dest = cfunc('fluid_mod_set_dest', c_void_p,
                          ('mod', c_void_p, 1),
                          ('dst', c_int, 1))

fluid_mod_set_source1 = cfunc('fluid_mod_set_source1', c_void_p,
                             ('mod', c_void_p, 1),
                             ('src', c_int, 1),
                             ('flags', c_int, 1))

fluid_mod_set_source2 = cfunc('fluid_mod_set_source2', c_void_p,
                             ('mod', c_void_p, 1),
                             ('src', c_int, 1),
                             ('flags', c_int, 1))

fluid_mod_set_transform = cfunc('fluid_mod_set_transform', c_void_p,
                               ('mod', c_void_p, 1),
                               ('type', c_int, 1))

fluid_mod_sizeof = cfunc('fluid_mod_sizeof', c_void_p)

fluid_mod_test_identity = cfunc('fluid_mod_test_identity', c_void_p,
                               ('mod1', c_void_p, 1),
                               ('mod2', c_void_p, 1))
