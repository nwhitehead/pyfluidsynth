...
fluid_version = cfunc(
    "fluid_version", c_void_p, ("major", POINTER(c_int), 1), ("minor", POINTER(c_int), 1), ("micro", POINTER(c_int), 1),
)
...
fluid_settings_setstr = cfunc(
    "fluid_settings_setstr", c_int, ("settings", c_void_p, 1), ("name", c_char_p, 1), ("str", c_char_p, 1),
)

fluid_settings_setnum = cfunc(
    "fluid_settings_setnum", c_int, ("settings", c_void_p, 1), ("name", c_char_p, 1), ("val", c_double, 1),
)

fluid_settings_setint = cfunc(
    "fluid_settings_setint", c_int, ("settings", c_void_p, 1), ("name", c_char_p, 1), ("val", c_int, 1),
)
...
fluid_settings_getnum = cfunc(
    "fluid_settings_getnum", c_int, ("settings", c_void_p, 1), ("name", c_char_p, 1), ("val", POINTER(c_double), 1),
)

fluid_settings_getint = cfunc(
    "fluid_settings_getint", c_int, ("settings", c_void_p, 1), ("name", c_char_p, 1), ("val", POINTER(c_int), 1),
)

delete_fluid_settings = cfunc("delete_fluid_settings", None, ("settings", c_void_p, 1))

fluid_synth_activate_key_tuning = cfunc(
...
fluid_synth_activate_tuning = cfunc(
...
fluid_synth_deactivate_tuning = cfunc(
    "fluid_synth_deactivate_tuning", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("apply", c_int, 1),
)

fluid_synth_tuning_dump = cfunc(
...
fluid_synth_sfload = cfunc(
    "fluid_synth_sfload", c_int, ("synth", c_void_p, 1), ("filename", c_char_p, 1), ("update_midi_presets", c_int, 1),
)

fluid_synth_sfunload = cfunc(
    "fluid_synth_sfunload", c_int, ("synth", c_void_p, 1), ("sfid", c_int, 1), ("update_midi_presets", c_int, 1),
)
...
fluid_synth_noteon = cfunc(
    "fluid_synth_noteon", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("key", c_int, 1), ("vel", c_int, 1),
)

fluid_synth_noteoff = cfunc("fluid_synth_noteoff", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("key", c_int, 1))

fluid_synth_pitch_bend = cfunc(
    "fluid_synth_pitch_bend", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("val", c_int, 1),
)

fluid_synth_cc = cfunc(
    "fluid_synth_cc", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("ctrl", c_int, 1), ("val", c_int, 1),
)

fluid_synth_get_cc = cfunc(
    "fluid_synth_get_cc", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("num", c_int, 1),
    ("pval", POINTER(c_int), 1),
)

fluid_synth_program_change = cfunc(
    "fluid_synth_program_change", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("prg", c_int, 1),
)
...
fluid_synth_bank_select = cfunc(
    "fluid_synth_bank_select", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("bank", c_int, 1),
)

fluid_synth_sfont_select = cfunc(
    "fluid_synth_sfont_select", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1), ("sfid", c_int, 1),
)
...
fluid_synth_all_sounds_off = cfunc("fluid_synth_all_sounds_off", c_int, ("synth", c_void_p, 1), ("chan", c_int, 1))
...
fluid_synth_set_reverb_roomsize = cfunc(
    "fluid_synth_set_reverb_roomsize", c_int, ("synth", c_void_p, 1), ("roomsize", c_double, 1),
)

fluid_synth_set_reverb_damp = cfunc("fluid_synth_set_reverb_damp", c_int, ("synth", c_void_p, 1), ("damping", c_double, 1))

fluid_synth_set_reverb_level = cfunc("fluid_synth_set_reverb_level", c_int, ("synth", c_void_p, 1), ("level", c_double, 1))

fluid_synth_set_reverb_width = cfunc("fluid_synth_set_reverb_width", c_int, ("synth", c_void_p, 1), ("width", c_double, 1))

fluid_synth_set_chorus_nr = cfunc("fluid_synth_set_chorus_nr", c_int, ("synth", c_void_p, 1), ("nr", c_int, 1))

fluid_synth_set_chorus_level = cfunc("fluid_synth_set_chorus_level", c_int, ("synth", c_void_p, 1), ("level", c_double, 1))

fluid_synth_set_chorus_speed = cfunc("fluid_synth_set_chorus_speed", c_int, ("synth", c_void_p, 1), ("speed", c_double, 1))

fluid_synth_set_chorus_depth = cfunc(
    "fluid_synth_set_chorus_depth", c_int, ("synth", c_void_p, 1), ("depth_ms", c_double, 1),
)

fluid_synth_set_chorus_type = cfunc("fluid_synth_set_chorus_type", c_int, ("synth", c_void_p, 1), ("type", c_int, 1))
...
fluid_synth_get_chorus_speed_Hz = cfunc("fluid_synth_get_chorus_speed_Hz", c_double, ("synth", c_void_p, 1))

fluid_synth_get_chorus_depth_ms = cfunc("fluid_synth_get_chorus_depth_ms", c_double, ("synth", c_void_p, 1))

fluid_synth_get_chorus_type = cfunc("fluid_synth_get_chorus_type", c_int, ("synth", c_void_p, 1))

fluid_synth_set_midi_router = cfunc("fluid_synth_set_midi_router", None, ("synth", c_void_p, 1), ("router", c_void_p, 1))

fluid_synth_handle_midi_event = cfunc(
    "fluid_synth_handle_midi_event", c_int, ("data", c_void_p, 1), ("event", c_void_p, 1),
)
...
fluid_sequencer_register_fluidsynth = cfunc(
    "fluid_sequencer_register_fluidsynth", c_short, ("seq", c_void_p, 1), ("synth", c_void_p, 1),
)
...
fluid_event_noteon = cfunc(
    "fluid_event_noteon", None, ("evt", c_void_p, 1), ("channel", c_int, 1), ("key", c_short, 1), ("vel", c_short, 1),
)

fluid_event_noteoff = cfunc("fluid_event_noteoff", None, ("evt", c_void_p, 1), ("channel", c_int, 1), ("key", c_short, 1))

delete_fluid_event = cfunc("delete_fluid_event", None, ("evt", c_void_p, 1))

fluid_midi_event_get_channel = cfunc("fluid_midi_event_get_channel", c_int, ("evt", c_void_p, 1))

fluid_midi_event_get_control = cfunc("fluid_midi_event_get_control", c_int, ("evt", c_void_p, 1))

fluid_midi_event_get_program = cfunc("fluid_midi_event_get_program", c_int, ("evt", c_void_p, 1))

fluid_midi_event_get_key = cfunc("fluid_midi_event_get_key", c_int, ("evt", c_void_p, 1))

fluid_midi_event_get_type = cfunc("fluid_midi_event_get_type", c_int, ("evt", c_void_p, 1))

fluid_midi_event_get_value = cfunc("fluid_midi_event_get_value", c_int, ("evt", c_void_p, 1))

fluid_midi_event_get_velocity = cfunc("fluid_midi_event_get_velocity", c_int, ("evt", c_void_p, 1))
...
fluid_mod_clone = cfunc("fluid_mod_clone", c_void_p, ("mod", c_void_p, 1), ("src", c_void_p, 1))
...
fluid_mod_get_transform = cfunc("fluid_mod_get_transform", c_void_p, ("mod", c_void_p, 1))

fluid_mod_has_dest = cfunc("fluid_mod_has_dest", c_void_p, ("mod", c_void_p, 1), ("gen", c_uint, 1))
...
fluid_mod_set_amount = cfunc("fluid_mod_set_amount", c_void_p, ("mod", c_void_p, 1), ("amount", c_double, 1))

fluid_mod_set_dest = cfunc("fluid_mod_set_dest", c_void_p, ("mod", c_void_p, 1), ("dst", c_int, 1))
...
fluid_mod_set_transform = cfunc("fluid_mod_set_transform", c_void_p, ("mod", c_void_p, 1), ("type", c_int, 1))

fluid_mod_sizeof = cfunc("fluid_mod_sizeof", c_void_p)

fluid_mod_test_identity = cfunc("fluid_mod_test_identity", c_void_p, ("mod1", c_void_p, 1), ("mod2", c_void_p, 1))
...
delete_fluid_player = cfunc("delete_fluid_player", None, ("player", c_void_p, 1))

fluid_player_add = cfunc("fluid_player_add", c_int, ("player", c_void_p, 1), ("filename", c_char_p, 1))
...
fluid_player_set_tempo = cfunc(
    "fluid_player_set_tempo", c_int, ("player", c_void_p, 1), ("tempo_type", c_int, 1), ("tempo", c_double, 1),
)
...
# fluid audio driver
new_fluid_audio_driver = cfunc("new_fluid_audio_driver", c_void_p, ("settings", c_void_p, 1), ("synth", c_void_p, 1))
...
fluid_midi_router_handle_midi_event = cfunc(
    "fluid_midi_router_handle_midi_event", c_int, ("data", c_void_p, 1), ("event", c_void_p, 1),
)

fluid_midi_router_clear_rules = cfunc("fluid_midi_router_clear_rules", c_int, ("router", POINTER(fluid_midi_router_t), 1))

fluid_midi_router_set_default_rules = cfunc(
    "fluid_midi_router_set_default_rules", c_int, ("router", POINTER(fluid_midi_router_t), 1),
)
...
delete_fluid_file_renderer = cfunc("delete_fluid_file_renderer", None, ("renderer", c_void_p, 1))

fluid_file_renderer_process_block = cfunc("fluid_file_renderer_process_block", c_int, ("render", c_void_p, 1))

# fluidsynth 2.x
new_fluid_cmd_handler = cfunc("new_fluid_cmd_handler", c_void_p, ("synth", c_void_p, 1), ("router", c_void_p, 1))
...
fluid_sfont_get_preset = cfunc(
    "fluid_sfont_get_preset", c_void_p, ("sfont", c_void_p, 1), ("banknum", c_int, 1), ("prenum", c_int, 1),
)
...
fluid_synth_get_chorus_speed = cfunc("fluid_synth_get_chorus_speed", c_double, ("synth", c_void_p, 1))

fluid_synth_get_chorus_depth = cfunc("fluid_synth_get_chorus_depth", c_double, ("synth", c_void_p, 1))
